        ...
        <div className="w-full max-w-3xl mx-auto py-12 px-4">
            ...
            <div className="w-full bg-primary rounded-xl shadow-lg p-6">
                {faqItems.map((item, index) => (
                    <div
                        key={index}
                        className={`mb-4 border-b rounded-lg overflow-hidden ${openItem === index ? "bg-secondary shadow-md" : "hover:bg-white/50 transition-colors"
                            }`}
                    >
                        <button
                        ...
                        >
                            ...
                            <ChevronDown
                                className={`h-5 w-5 text-orange-500 transition-transform duration-300 ${openItem === index ? "transform rotate-180" : ""
                                    }`}
                            />
                        </button>
                        <div
                            id={`faq-answer-${index}`}
                            className={`overflow-hidden transition-all duration-300 ease-in-out ${openItem === index ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"
                                }`}
                        >
