    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            <Card className="bg-secondary">
                ...
                <CardContent className="space-y-4">
                    <p className="text-sm leading-relaxed">
                        MetaCashback collects only the necessary user data to facilitate cashback processing and improve platform functionality.
                        This data includes transaction history, wallet interactions, and preferences set by users.
                    </p>
                    <p className="text-sm leading-relaxed">
            ...
            <Card className="bg-secondary">
                ...
                <CardContent className="space-y-4">
                    <p className="text-sm">
                        MetaCashback does not sell or share personal data with third parties. Secure encryption and privacy measures are
                        implemented to ensure data protection.
                    </p>
                </CardContent>
            </Card>
            ...
            <Card className="bg-secondary">
                ...
                <CardContent>
                    <p className="text-sm mb-3">
                        Users have control over their data and can modify privacy settings at any time.
                        Requests for data access or deletion can be submitted via official support channels.
                    </p>
                </CardContent>
            </Card>
